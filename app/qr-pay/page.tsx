...
export default function QRPay() {
  ...
  // Success handler to be passed to CheckoutPage
      ...
      <Card className="w-full max-w-2xl mx-auto shadow-xl border bg-background p-2 md:p-6">
        {!success ? (
            ...
            <CardContent>
              ...
              <div className="w-full flex flex-col items-center justify-center min-h-[300px] mt-6">
                {showStripeForm && isValidAmount ? (
                  ...
                  >
                    <CheckoutPage amount={Number(amount)} onSuccess={handlePaymentSuccess} />
                  </Elements>
                ) : (
          ...
          <div className="flex flex-col items-center justify-center min-h-[400px]">
            ...
            <div className="text-3xl font-extrabold text-center text-red-800 mb-2">Payment Successful</div>
            ...
            <div className="text-sm text-muted-foreground text-center">A confirmation has been sent to your email.</div>
          </div>
        )}
      </Card>
    </div>
